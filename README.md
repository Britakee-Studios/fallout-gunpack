# [Unofficial] NeoForge Port of LesRaisins Studio's Fallout-themed [TACZ] Fallout Gunpack

**DO NOT REPORT ANY BUGS WITH THIS PORT TO THE ORIGINAL DEVS!** Report bugs here in this project's issues tab.
...
- Place the `.jar` file in your `mods` folder **(not** tacz gunpack path).
- Requires **TaCZ 1.1.6+** for **Minecraft 1.21.1** (NeoForge loader).
